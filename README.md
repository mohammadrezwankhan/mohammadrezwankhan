...
|---|---|---|
| **[MATLAB Simulink Energy Lab](https://github.com/mohammadrezwankhan/matlab-simulink-energy-lab)** | How do battery, converter, and BESS-control models behave under explicit checks? | 18 check entry points; 31-result focused BESS suite; CI; [v0.10.0](https://github.com/mohammadrezwankhan/matlab-simulink-energy-lab/releases/tag/v0.10.0); held-out tests; explicit limitations. |
